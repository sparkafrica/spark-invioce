              ...
              <Table className="bg-white">
                <TableHeader className="bg-[#f3f2f2]">
                  <TableRow className="border-b-2 border-[#201e1d] hover:bg-transparent">
                    ...
                    <TableHead className="px-4 py-3 text-left text-xs font-semibold uppercase tracking-wider text-[#c02a10] h-auto">DESCRIPTION</TableHead>
                    <TableHead className="px-4 py-3 text-right text-xs font-semibold uppercase tracking-wider text-[#c02a10] h-auto">COST</TableHead>
                    <TableHead className="px-4 py-3 text-left text-xs font-semibold uppercase tracking-wider text-[#c02a10] h-auto">CURRENCY</TableHead>
                ...
                <TableBody className="divide-y divide-[#d6d3d1]">
                  {filteredProducts.map((product) => (
                    <TableRow key={product.id} className="hover:bg-[#f0dcd8]">
                      ...
                      <TableCell className="px-4 py-3 text-[#5c5755]">{product.description || '-'}</TableCell>
                      <TableCell className="px-4 py-3 text-right font-mono">{new Intl.NumberFormat('en-US', { minimumFractionDigits: 2, maximumFractionDigits: 2 }).format(Number(product.cost))}</TableCell>
                      ...
                      <TableCell className="px-4 py-3 text-right">
                        <div className="flex items-center justify-end gap-2">
                          ...
                          <Button variant="ghost" size="icon" className="text-[#c02a10]" onClick={() => deleteMutation.mutate(product.id)} disabled={deleteMutation.isPending}>
