...
export const invoiceSchema = v.object({
  ...
  status: v.optional(
    v.picklist(['draft', 'paid', 'part_paid', 'due', 'overdue', 'voided']),
  ),
        ...
        <div className="border-t-2 border-[#201e1d] pt-5">
          ...
          <div className="border-t border-[#d6d3d1] pt-3">
            <div className="flex flex-col gap-3">
              ...
              <Button
                type="button"
                className="bg-[#201e1d] text-white border border-[#201e1d] text-[11px] font-semibold hover:bg-[#c02a10] rounded-none self-start"
              >
                Post comment
              </Button>
            </div>
