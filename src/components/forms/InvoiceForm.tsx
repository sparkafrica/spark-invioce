...
export function InvoiceForm({
	...
	const editTitle = isEditing
		? `Edit ${initialData?.businessId || 'Invoice'}`
		: 'New invoice';

	return (
		<form
			onSubmit={handleSubmit}
			className="grid lg:grid-cols-[1.55fr_1fr] gap-8 items-start py-6"
		...
		>
				...
				<div className="flex items-center justify-between gap-4 border-b-2 border-[#201e1d] pb-3">
					...
					<div className="flex gap-2">
						...
						<Button
							...
							size="sm"
							variant="default"
							className="flex-1 bg-[#ec3013] text-white border border-[#ec3013] py-2.5 px-6 text-xs font-semibold hover:bg-[#c02a10] rounded-none"
						>
			...
			<div className="border-l-2 border-[#201e1d] pl-6 flex flex-col gap-5 lg:sticky lg:top-[72px] self-start">
				<div>
					<div className="text-[10px] tracking-[0.12em] font-semibold mb-2.5">
						SAVE NOTE
					</div>
					<Textarea
						value={saveNote}
