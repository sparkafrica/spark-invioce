	...
	return (
		...
		>
			<div className="flex items-center gap-[22px]">
				...
				<nav
					className="hidden md:flex items-center gap-0.75 flex-wrap"
				...
				{isPending ? (
					...
					<>
						<div className="hidden sm:block text-right leading-[1.2]">
							...
							<div className="text-[10px] tracking-widest text-[#5c5755]">
								{roleLabel}
							</div>
						</div>
						<Button
					...
					<Link
						to="/auth/login"
						className="border border-[#201e1d] bg-white px-2.5 py-2 text-xs font-semibold text-[#201e1d] hover:bg-[#f0dcd8]"
						style={{ padding: '8px 11px', fontSize: 12 }}
					>
						Sign in
					</Link>
