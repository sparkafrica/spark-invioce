		...
		return (
			<div className="min-h-screen bg-[#f3f2f2] text-[#201e1d] grid place-items-center p-6">
				<div className="max-w-md text-center space-y-4">
					...
					<Link
						to="/auth/login"
						className="text-sm font-semibold text-[#c02a10] hover:underline"
					>
						Back to sign in
					</Link>
				</div>
				...
				<div className="hidden lg:flex flex-col justify-between border-r-2 border-[#201e1d] px-14 py-16">
					...
					<div>
						<h1 className="max-w-[9em] text-[32px] font-medium leading-[1.02] tracking-[-0.03em]">
							Accept your invitation to Spark
						</h1>
						<p className="mt-5 max-w-[34em] text-sm leading-6 text-[#5c5755]">
							Join the team and start managing invoices, memos and money across
